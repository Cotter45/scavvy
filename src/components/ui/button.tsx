...
export const buttonVariants = {
  base: [
    ...
    // Sizing
    "px-[calc(theme(spacing[6])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing.3)-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] sm:text-sm/6",
    // Focus
    "focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-emerald-600",
    // Disabled
  ...
  outline: [
    ...
    // Dark mode
    "dark:border-white/5 dark:text-white dark:[--btn-bg:transparent] dark:data-[active]:bg-white/5 dark:data-[hover]:bg-white/5",
    // Icon
...
export const Button = forwardRef(function Button(
  ...
  const classes = clsx(
    ...
    outline
      ...
      : clsx(buttonVariants.solid, buttonVariants.colors[color ?? "dark/zinc"]),
    className
  );
