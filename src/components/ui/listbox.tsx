  ...
  return (
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          // Basic layout
          "group relative block w-full truncate",
          ...
          "focus:outline-none",
          // Focus ring
          "after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:data-[focus]:ring-2 after:data-[focus]:ring-emerald-600",
          // Disabled state
      ...
      <Headless.ListboxOptions
        ...
        className={clsx(
          ...
          // Base styles
          "isolate w-max min-w-[var(--button-width)] sm:min-w-[calc(var(--button-width)+1.75rem)] select-none scroll-py-1 rounded-xl p-1",
        ...
        return (
          <div
            className={clsx(
              ...
              // Focus
              "outline-none data-[focus]:bg-emerald-600 data-[focus]:text-white",
              // Forced colors mode
