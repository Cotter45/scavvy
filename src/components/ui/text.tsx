...
export function TextLink({
  ...
  return (
    <Link
      ...
      className={clsx(
        className,
        "text-emerald-600 hover:underline decoration-zinc-950/50 data-[hover]:decoration-zinc-950 dark:text-emerald-600 dark:decoration-emerald-600/50 dark:data-[hover]:decoration-emerald-600/50",
      )}
    />
  );
}
